		...
		Category{
			...
			SubShader {
				Pass {
					...
					half _ColorPyramidTextureScale;
					...
					fixed4 frag(v2f i) : COLOR
					{
						...
						half2 offset = normal.rg * _BumpAmt * _ColorPyramidTexture_TexelSize.xy * i.color.a * _ColorPyramidTextureScale;
						i.grab.xy = offset * i.grab.z + i.grab.xy;
						half4 col = tex2Dproj(_ColorPyramidTexture, UNITY_PROJ_COORD(i.grab));
